...
const Home = () => {
  ...
  const spaceElements = Array.from({ length: 20 }, (_, i) => ({
    ...
    icon: [Badge, Star, Circle, Diamond, Sparkles][Math.floor(Math.random() * 5)]
  }))
  ...
  return (
    <div className='bg-gradient-to-b from-gray-800 to-slate-800 min-h-screen relative'>
      ...
      <div className='relative z-10 flex flex-col'>
        ...
        >
          <h1 className='font-mono text-3xl text-violet-100 cursor-pointer' onClick={() => navigate('/')}>F.i.C.</h1>
        </motion.header>
        ...
        <main className='flex flex-col justify-center items-center px-4 min-h-screen'>
          <section>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1, transition: { staggerChildren: 0.4 }, animationDelay: 0.5 }}
            >
              <motion.div
              ...
              >
                Discover the cosmos of fashion with our AI-powered classifier. Upload your fashion items and let our intelligent system identify and categorize them with stellar precision.
              </motion.div>
            </motion.div>
          </section>
        </main>
            ...
            <div className='grid md:grid-cols-3 gap-8 max-w-4xl mx-auto'>
              ...
              >
                ...
                <p className='text-white/70'>
                  Simply drag and drop or select your fashion item image to begin the classification process.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className='text-white/70'>
                  Our advanced AI algorithms analyze your image using cutting-edge computer vision technology.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className='text-white/70'>
                  Receive detailed classification results with confidence scores and item categories.
                </p>
              </motion.div>
            </div>
              ...
              >
                ...
                <div className='grid md:grid-cols-2 gap-8 max-w-3xl mx-auto'>
                  <div className='bg-white/5 rounded-xl p-6'>
                    <h4 className='text-xl font-semibold text-white mb-3'>Accurate Classification</h4>
                    <p className='text-white/70'>
                      Advanced machine learning models trained on millions of fashion items for precise categorization.
                    </p>
                  </div>
                  <div className='bg-white/5 rounded-xl p-6'>
                    <h4 className='text-xl font-semibold text-white mb-3'>Real-time Processing</h4>
                    <p className='text-white/70'>
                      Lightning-fast analysis that provides results in seconds, not minutes.
                    </p>
                  </div>
                  <div className='bg-white/5 rounded-xl p-6'>
                    <h4 className='text-xl font-semibold text-white mb-3'>Multiple Categories</h4>
                    <p className='text-white/70'>
                      Supports classification of clothing, accessories, shoes, and more fashion categories.
                    </p>
                  </div>
                  <div className='bg-white/5 rounded-xl p-6'>
                    <h4 className='text-xl font-semibold text-white mb-3'>Confidence Scores</h4>
                    <p className='text-white/70'>
                      Detailed confidence metrics help you understand the reliability of each classification.
                    </p>
                  </div>
                </div>
              </motion.div>
